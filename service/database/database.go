...
func New(db *sql.DB) (AppDatabase, error) {
	...
	if !errors.Is(err, nil) && !errors.Is(err, sql.ErrNoRows) {
		...
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u18", "18181818-1818-1818-1818-181818181818", "Rosalinda", "/tmp/images/u18-photo-0-photo-profile.jpg", "I am Rosalinda Bros", now, 0, 0, 0, "Rosalinda", "Bros", "2000-01-01", "rosalinda.1952442@studenti.uniroma1.it", "Italian", "female")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u17", "17171717-1717-1717-1717-171717171717", "Peach", "/tmp/images/u17-photo-0-photo-profile.png", "I am Peach Bros", now, 0, 0, 0, "Peach", "Bros", "2000-01-01", "peach.1952442@studenti.uniroma1.it", "Italian", "female")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u16", "16161616-1616-1616-1616-161616161616", "Yoshi", "/tmp/images/u16-photo-0-photo-profile.png", "I am Yoshi Bros", now, 0, 0, 0, "Yoshi", "Bros", "2000-01-01", "yoshi.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u15", "15151515-1515-1515-1515-151515151515", "Mario", "/tmp/images/u15-photo-0-photo-profile.jpg", "I am Mario Bros", now, 0, 0, 0, "Mario", "Bros", "2000-01-01", "mario.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u14", "14141414-1414-1414-1414-141414141414", "TipoTimido", "/tmp/images/u14-photo-0-photo-profile.png", "I am Tipo Timido", now, 0, 0, 0, "Tipo", "Timido", "2000-01-01", "tipo.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u13", "13131313-1313-1313-1313-131313131313", "Lakitu", "/tmp/images/u13-photo-0-photo-profile.jpeg", "I am Lakitu Bros", now, 0, 0, 0, "Lakitu", "Bros", "2000-01-01", "lakitu.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u12", "12121212-1212-1212-1212-121212121212", "Koopa", "/tmp/images/u12-photo-0-photo-profile.jpeg", "I am Koopa Bros", now, 0, 0, 0, "Koopa", "Bros", "2000-01-01", "koopa.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u11", "10101010-1010-1010-1010-101010101010", "DonkeyKong", "/tmp/images/u11-photo-0-photo-profile.jpeg", "I am Donkey Kong", now, 0, 0, 0, "Donkey", "Kong", "2000-01-01", "donkey.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u10", "99999999-9999-9999-9999-9999999999999999", "Bowser", "/tmp/images/u10-photo-0-photo-profile.jpg", "I am Bowser Bros", now, 0, 0, 0, "Bowser", "Bros", "2000-01-01", "bowser.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u9", "88888888-8888-8888-8888-888888888888", "Wario", "/tmp/images/u9-photo-0-photo-profile.jpeg", "I am Wario Bros", now, 0, 0, 0, "Wario", "Bros", "2000-01-01", "wario.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u8", "77777777-7777-7777-7777-777777777777", "Luigi", "/tmp/images/u8-photo-0-photo-profile.png", "I am Luigi Bros", now, 0, 0, 0, "Luigi", "Bros", "2000-01-01", "luigi.1952442@studenti.uniroma1.it", "Italian", "male")

		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u7", "66666666-6666-6666-6666-666666666666", "chicca78", "/tmp/images/No-Picture-Available.png", "I am the WASAPhoto Owner's Aunt", now, 0, 0, 0, "Francesca", "Borgi", "1978-10-07", "mario.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u6", "55555555-5555-5555-5555-555555555555", "samantha01", "/tmp/images/u6-photo-0-photo-profile.jpeg", "I am the WASAPhoto Owner's Girlfriend", now, 0, 0, 0, "Samantha", "Sorrentino", "2001-10-26", "samantha.1952442@studenti.uniroma1.it", "Italian", "female")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u5", "44444444-4444-4444-4444-444444444444", "aurora46", "/tmp/images/No-Picture-Available.png", "I am the WASAPhoto Owner's Grandma", now, 0, 0, 0, "Aurora", "Melis", "1946-08-27", "aurora.1952442@studenti.uniroma1.it", "Italian", "female")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u4", "33333333-3333-3333-3333-333333333333", "alice05", "/tmp/images/No-Picture-Available.png", "I am the WASAPhoto Owner's Sister", now, 0, 0, 0, "Alice", "Borgi", "2005-12-16", "alice.1952442@studenti.uniroma1.it", "Italian", "female")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u3", "22222222-2222-2222-2222-222222222222", "andrea71", "/tmp/images/No-Picture-Available.png", "I am the WASAPhoto Owner's Dad", now, 0, 0, 0, "Andrea", "Borgi", "1971-09-06", "andrea.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u2", "11111111-1111-1111-1111-111111111111", "anna69", "/tmp/images/No-Picture-Available.png", "I am the WASAPhoto Owner's Mum", now, 0, 0, 0, "Anna", "Mauti", "1969-07-29", "anna.1952442@studenti.uniroma1.it", "Italian", "female")
		_, errCretion := db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u1", "00000000-0000-0000-0000-000000000000", "alessioborgi01", "/tmp/images/u1-photo-0-photo-profile.jpg", "I am the WASAPhoto Owner", now, 0, 0, 0, "Alessio", "Borgi", "2001-04-17", "borgi.1952442@studenti.uniroma1.it", "Italian", "male")
