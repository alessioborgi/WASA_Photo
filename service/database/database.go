...
func New(db *sql.DB) (AppDatabase, error) {
	...
	if !errors.Is(err, nil) && !errors.Is(err, sql.ErrNoRows) {
		...
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u18", "18181818-1818-1818-1818-181818181818", "Rosalinda", "/tmp/images/No-Picture-Available.png", "I am Rosalinda Bros", now, 0, 0, 0, "Rosalinda", "Bros", "2000-01-01", "rosalinda.1952442@studenti.uniroma1.it", "Italian", "female")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u17", "17171717-1717-1717-1717-171717171717", "Peach", "/tmp/images/No-Picture-Available.png", "I am Peach Bros", now, 0, 0, 0, "Peach", "Bros", "2000-01-01", "peach.1952442@studenti.uniroma1.it", "Italian", "female")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u16", "16161616-1616-1616-1616-161616161616", "Yoshi", "/tmp/images/No-Picture-Available.png", "I am Yoshi Bros", now, 0, 0, 0, "Yoshi", "Bros", "2000-01-01", "yoshi.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u15", "15151515-1515-1515-1515-151515151515", "Mario", "/tmp/images/No-Picture-Available.png", "I am Mario Bros", now, 0, 0, 0, "Mario", "Bros", "2000-01-01", "mario.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u14", "14141414-1414-1414-1414-141414141414", "TipoTimido", "/tmp/images/No-Picture-Available.png", "I am Tipo Timido", now, 0, 0, 0, "Tipo", "Timido", "2000-01-01", "tipo.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u13", "13131313-1313-1313-1313-131313131313", "Lakitu", "/tmp/images/No-Picture-Available.png", "I am Lakitu Bros", now, 0, 0, 0, "Lakitu", "Bros", "2000-01-01", "lakitu.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u12", "12121212-1212-1212-1212-121212121212", "Koopa", "/tmp/images/No-Picture-Available.png", "I am Koopa Bros", now, 0, 0, 0, "Koopa", "Bros", "2000-01-01", "koopa.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u11", "10101010-1010-1010-1010-101010101010", "DonkeyKong", "/tmp/images/No-Picture-Available.png", "I am Donkey Kong", now, 0, 0, 0, "Donkey", "Kong", "2000-01-01", "donkey.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u10", "99999999-9999-9999-9999-9999999999999999", "Bowser", "/tmp/images/No-Picture-Available.png", "I am Bowser Bros", now, 0, 0, 0, "Bowser", "Bros", "2000-01-01", "bowser.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u9", "88888888-8888-8888-8888-888888888888", "Wario", "/tmp/images/No-Picture-Available.png", "I am Wario Bros", now, 0, 0, 0, "Wario", "Bros", "2000-01-01", "wario.1952442@studenti.uniroma1.it", "Italian", "male")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u8", "77777777-7777-7777-7777-777777777777", "Luigi", "/tmp/images/No-Picture-Available.png", "I am Luigi Bros", now, 0, 0, 0, "Luigi", "Bros", "2000-01-01", "luigi.1952442@studenti.uniroma1.it", "Italian", "male")
		...
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u6", "55555555-5555-5555-5555-555555555555", "samantha01", "/tmp/images/No-Picture-Available.png", "I am the WASAPhoto Owner's Girlfriend", now, 0, 0, 0, "Samantha", "Sorrentino", "2001-10-26", "samantha.1952442@studenti.uniroma1.it", "Italian", "female")
		_, _ = db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
		...
		_, errCretion := db.Exec(`INSERT INTO Users (fixedUsername, uuid, username, photoProfile, biography, dateOfCreation, numberOfPhotos, numberFollowers, numberFollowing, name, surname, dateOfBirth, email, nationality, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
			"u1", "00000000-0000-0000-0000-000000000000", "alessioborgi01", "/tmp/images/No-Picture-Available.png", "I am the WASAPhoto Owner", now, 0, 0, 0, "Alessio", "Borgi", "2001-04-17", "borgi.1952442@studenti.uniroma1.it", "Italian", "male")
